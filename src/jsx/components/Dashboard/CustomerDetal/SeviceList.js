	...
	return(
        ...
        <Dropdown className="dropdown">
            ...
            <Dropdown.Menu className="dropdown-menu">
                <Dropdown.Item className="dropdown-item" href='update-service'>Edit</Dropdown.Item>
                            ...
                            <td>
                                <div className="guest-bx">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="mb-0 mt-1"><Link  className="text-black" to={"./customer-table"}>Massage Skin</Link></h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div>
                                    <span className="fs-16">Masage</span>
                                </div>
                            </td>
                            <td>
                                <div>
                                    <span className="fs-16">120,000</span>
                                </div>
                            </td>
                            <td>
                                <div>
                                    
                                    <span className="fs-16">8:00AM-6:00PM</span>
                                </div>
                            </td>
                            <td>
                                <div>
