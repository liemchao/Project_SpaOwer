...
import GuestCarousel from './Booking/GuestCarousel';
...
const Room = () => {
  ...
  useEffect(() => {
    ...
    axios.get("http://bookings3v1.somee.com/api/v1/services").then((item) => {
        ...
        <div className="row">
          <div className="col-xl-12">
            <div className="d-flex mb-4 justify-content-between align-items-center flex-wrap">
              ...
              <Link to={"create-service"} className="btn btn-primary mb-xxl-0 mb-4">
                    ...
                    <table className="table card-table display mb-4 dataTablesCard booking-table room-list-tbl dataTable no-footer">
                      <thead>
                        <tr role="row">
                          ...
                          <th>Price</th>
                          <th className="text-center">Detail Service</th>
                          <th>Status</th>
                        ...
                        {dataTable.map((item) => {
                          return (
                            <tr role="row" className="odd">
                              ...
                              <td>
                                <div className="guest-bx">
                                  ...
                                  >
                                    ...
                                    <img src={item.urlImage} className="d-block w-100" alt="..." />
                                    </div>
                                  </div>
                                  <div>
                              ...
                              <td>
                                <div>
                                  <span className="fs-16"> {item.duration}</span>
                                </div>
                              </td>
                              ...
                              <div>
                                  <span className="text-success">{item.status?"True":"False"}</span>
                                </div>
                              </td>
                              <td>
                              <DropdownBlog />
