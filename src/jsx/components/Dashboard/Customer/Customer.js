...
/// images
import avartar5 from "../../../../../src/images/avatar/5.png";
import avartar1 from "../../../../../src//images/avatar/1.png";
...
const Customers = () => {
   ...
   return (
      <Fragment>
         <PageTitle activeMenu="Spa" motherMenu="Customers" />
         <div className="row">
            <div className="col-lg-12">
               <div className="card">
                  <div className="card-body">
                  <div className="mb-3-left 10">
							<Link to={"form-create"} className="btn btn-primary"><i className="far fa-file-word me-2"></i>Create</Link>	
						</div>
