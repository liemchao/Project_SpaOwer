...
///Import
import PendingBlog from './Customer/PendingBlog';
import BookedBlog from './Customer/BookedBlog';
import CanceledBlog from './Customer/CanceledBlog';
import RefundBlog from './Customer/RefundBlog';
		...
		<>
			<Dropdown className="dropdown">
				...
				<Dropdown.Menu className="dropdown-menu">
					<Dropdown.Item className="dropdown-item" href='/update-customer'>Edit</Dropdown.Item>
				...
				<div className="row">
					<div className="col-xl-12">
						<div className="d-flex mb-4 justify-content-between align-items-center flex-wrap">
							...
							<Link to={"create-customer"} className="btn btn-primary mb-xxl-0 mb-4 "><i className="far fa-file-word me-2"></i>Create</Link>
						</div>
						<Tab.Content>
