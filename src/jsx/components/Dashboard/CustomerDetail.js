...
import BookingSlider from './CustomerDetal/BookingSlider';
import HistoryBooking from './CustomerDetal/HistoryBooking';
					...
					<div className="card">	
						...
						<div className="card-body">
							...
							<div className="d-flex mt-4 flex-wrap">
								<h4 className="card-title me-auto">Service Facilities</h4>
						...
						<div className="card-body d-flex pt-0 align-items-center flex-wrap">
							...
							<div className="d-sm-flex d-block align-items-center">
								<div className="me-5 mb-sm-0 mb-3">
									<p className="mb-2"><i className="far fa-user scale3 me-3"></i>Service Capacity</p>
