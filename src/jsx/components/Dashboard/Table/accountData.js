...
const Room = () => {
  ...
  useLayoutEffect(() =>{
    console.log('aaaaaa')
    axios.get("http://bookings3v1.somee.com/api/users?role=cus&PAGE_SIZE=15").then((item) => {
  ...
  const onSearch = () => {
    ...
    axios
      .get(`http://bookings3v1.somee.com/api/users?role=cus&search=${searchValue}`)
      .then((item) => {
                          ...
                          return (
                            <tr role="row" className="odd">
                              ...
                              <td>
                                {" "}
                                <div>
                                  <span className="text-warning">{item.roleId} times</span>
                                </div>
                              </td>
                              <td>
                                <div>
                      ...
                      <tbody>
                        <tr role="row" className="odd">
                          ...
                          <td>
                            {" "}
                            <div>
                              <span className="text-warning">Host</span>
                            </div>
                          </td>
                          <td>
                            <div>
                    ...
                    <table className="table card-table display mb-4 dataTablesCard booking-table room-list-tbl dataTable no-footer">
                      ...
                      <tbody>
                        <tr role="row" className="odd">
                          ...
                          <td>
                            <div>
                              <span className="text-danger">Baned</span>
                            </div>
                          </td>
                          <td>
                            <div class="in-block">
