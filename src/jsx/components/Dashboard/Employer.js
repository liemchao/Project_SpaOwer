...
///Import
import Inactive from './Employer/Inactive';
import Active from './Employer/Active';
		...
		<>
			<Dropdown className="dropdown">
				...
				<Dropdown.Menu className="dropdown-menu">
					<Dropdown.Item className="dropdown-item" href='/update-staff'>Edit</Dropdown.Item>
				...
				<div className="row">
					<div className="col-xl-12">
						<div className="d-flex mb-4 justify-content-between align-items-center flex-wrap">
							...
							<Link to={"/create-staff"} className="btn btn-primary mb-xxl-0 mb-4 "><i className="far fa-file-word me-2"></i>Create</Link>
						</div>
						<Tab.Content>
										...
										>
											<thead>
												<tr role="row">
													...
													<th className="sorting_asc">Staff Name</th>
											...
											<tbody>
												<tr role="row" className="odd">
													...
													<td>
														<div className="concierge-bx">
															...
															<div>
																...
																<h4 className="mt-1"><Link className="text-black" to={"./guest-detail"}>Lien Chao</Link></h4>
													...
													<td className="job-desk">
														<div>
															<span className="fs-16">Quan9,HCM</span>
														</div>
													</td>
													<td>
														<div>
															<h5 className="font-w600"></h5>
