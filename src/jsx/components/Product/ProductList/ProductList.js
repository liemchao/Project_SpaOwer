...
// images
import avatar1 from "../../../../../src/images/avatar/pic1.jpg";
// import product4 from "../../../../../src/images/product/4.jpg";
// import product5 from "../../../../../src/images/product/5.jpg";
// import product6 from "../../../../../src/images/product/6.jpg";
// import product7 from "../../../../../src/images/product/7.jpg";

const ProductList = () => {
  const [reviewModal, setReviewModal] = useState(false);
  return (
    <Fragment>
      <PageTitle activeMenu="Sevice" motherMenu="All Spa" />
              ...
              <div className="row m-b-30">
                <div className="col-md-5 col-xxl-12">
                  <div className="new-arrival-product mb-4 mb-xxl-4 mb-md-0">
                    <div className="new-arrivals-img-contnent">
                      <img className="img-fluid" src="https://saffronnegin.com/wp-content/uploads/2021/01/kham-pha-dich-vu-lam-dep-an-toan-hieu-qua-tai-tham-my-vien-xavia-spa-co-kinh-nghiem.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div className="col-md-7 col-xxl-12">
                  <div className="new-arrival-content position-relative">
                    ...
                    <p>
                      Spa Name: <span className="item">Ga S3</span>{" "}
                    </p>
                    <p>
                      Service code: <span className="item">0405689</span>{" "}
                    </p>
                    <p>
                      Service type: <span className="item">Massaga</span>
                    </p>
                    <p className="text-content">
                          You have an choice with employer beutifull
                    </p>
                  </div>
                </div>
              </div>
